...
function MetricCard({ label, value, icon, accent, iconBg, sub }: MetricCardProps) {
  return (
      ...
      <View style={styles.body}>
        ...
        <View style={styles.metricsRow}>
          <MetricCard
            ...
            accent="#22C55E"
            iconBg="#F0FDF4"
            sub={`${metrics.completedSites} completed`}
          />
          <MetricCard
            label="Total Entries"
        ...
        <View style={styles.metricsRow}>
          <MetricCard
            label="Approved Diaries"
            value={metrics.approvedDiaries}
            icon="checkmark-circle"
            accent={Colors.accent}
            iconBg="#FFF7ED"
            sub={`${metrics.approvalRate}% approval rate`}
          />
          <MetricCard
            label="Pending Review"
            value={metrics.draftDiaries}
            icon="time"
        ...
        {diaries.length > 0 && (
          <View style={styles.healthCard}>
            ...
            <Text style={styles.healthSub}>
              {metrics.approvedDiaries} of {diaries.length} diaries approved
            </Text>
          </View>
        )}
